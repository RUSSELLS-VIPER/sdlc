...
import bannerVideo from "../../assets/images/contacts-images/contact-video.mp4";

const HeroContact = () => {
  return (
    <div className="text-white antialiased">
      <div className="relative w-full h-[50vh] min-h-[400px] flex flex-col overflow-hidden">
        ...
        <div className="relative z-10 flex-grow flex flex-col items-center justify-center text-center px-4">
          <h1 className="text-white text-4xl sm:text-5xl md:text-7xl font-semibold mb-4 leading-tight">
            Contacts Us
          </h1>
