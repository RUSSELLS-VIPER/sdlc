  ...
  useEffect(() => {
    ...
    on(document.getElementById("prev-btn"), "click", () => {
      ...
      if (projectsSlider.scrollLeft <= 10) {
        projectsSlider.scrollTo({ left: projectsSlider.scrollWidth, behavior: "smooth" });
      } else {
    ...
    on(document.getElementById("next-btn"), "click", () => {
      ...
      projectsSlider.scrollTo({
        left: projectsSlider.scrollLeft >= maxScroll - 10 ? 0 : projectsSlider.scrollLeft + scrollAmount,
        behavior: "smooth",
      });
    });
        ...
        <section className="bg-[#f3f6f9] py-16 lg:py-24">
              <div className="mx-auto w-full max-w-[1320px] px-6">
                <div className="flex flex-col lg:flex-row items-center w-full relative">
                  <div className="w-full lg:w-1/2 pr-0 lg:pr-12 space-y-10">
                    <div>
                      <h2 className="text-4xl md:text-6xl font-bold text-[#161d2d] mb-6">
                        <span className="text-gray-400 font-light">#</span>Trusted By 1
                        Million Clients
                      </h2>
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                        <div>
                          <div className="text-3xl font-bold text-[#161d2d] mb-1">1M</div>
                          <div className="text-[13px] text-[#475569] font-medium">
                            Happy buyers
                          </div>
                        </div>
                        <div>
                          <div className="text-3xl font-bold text-[#161d2d] mb-1">100K</div>
                          <div className="text-[13px] text-[#475569] font-medium">
                            Clients reviews
                          </div>
                        </div>
                        <div>
                          <div className="text-3xl font-bold text-[#161d2d] mb-1">4.8</div>
                          <div className="text-[13px] text-[#475569] font-medium">
                            Positive rating
                          </div>
                        </div>
                    ...
                    <button
                      className="px-8 py-2.5 border border-gray-300 rounded-lg text-sm text-[#161d2d] font-medium hover:bg-[#161d2d] hover:text-white transition-all duration-300"
                    >
                      Learn More
                    </button>
                  </div>
                  ...
                  <div
                    className="w-full lg:w-1/2 h-[580px] custom-scrollbar overflow-y-auto [direction:rtl] mt-16 lg:mt-0"
                  >
                    <div className="[direction:ltr] ml-8 lg:ml-16 space-y-6 pb-4">
                      <div
                        className="relative bg-white p-5 md:p-6 lg:p-8 rounded-2xl md:rounded-[2rem] group hover:bg-[#161d2d] hover:-translate-x-1 transition-all duration-300 cursor-pointer border border-transparent"
                      >
                        <div className="flex gap-4 md:gap-5">
                          <div className="shrink-0">
                            <div
                              className="w-10 h-10 md:w-12 md:h-12 bg-[#161d2d] group-hover:bg-white group-hover:text-[#161d2d] rounded-full flex items-center justify-center text-white shadow-md transition-colors duration-300"
                            >
                              <svg
                          ...
                          <div className="pb-10 md:pb-12">
                            <h3
                              className="text-lg md:text-xl lg:text-[22px] font-semibold text-[#161d2d] group-hover:text-white leading-snug transition-colors duration-300"
                            >
                              Two Decades Of Building Excellence and Trust
                            </h3>
                            <p
                              className="mt-2 md:mt-3 text-xs md:text-sm text-[#475569] group-hover:text-gray-200 leading-relaxed transition-colors duration-300"
                            >
                              Infinity Horizon has evolved to become one of the leading
                              Real Estate developers in Eastern India and parts of
                              Southern India.
                            </p>
                          </div>
                        </div>
                        ...
                        <div
                          className="absolute bottom-4 right-4 md:bottom-6 md:right-6 w-9 h-9 md:w-11 md:h-11 bg-[#161d2d] group-hover:bg-white group-hover:text-[#161d2d] rounded-lg md:rounded-xl flex items-center justify-center text-white group-hover:scale-105 transition-all duration-300 shadow-md"
                        >
                          <svg
              ...
              <div className="max-w-[1320px] mx-auto px-4 sm:px-6">
                <div className="mb-10">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                    ...
                    >
                      <i
                        className="fa-solid fa-arrow-right text-xs sm:text-sm md:text-base"
                      ></i>
                    </Link>
                  </div>
                </div>
                ...
                {!loading && !error && filteredPopularItems.map((item)=> (
                  ...
                  >
                    <div className="relative h-[220px] bg-gray-200">
                      ...
                      />
                      <div
                        className="absolute top-4 left-0 bg-[#f59e0b] text-white text-xs font-bold px-4 py-1.5 ribbon pr-6"
                      >
                        Special Offers
                      </div>
                    </div>
            ...
            <section className="py-16">
              <div
                className="max-w-[1320px] mx-auto px-4 sm:px-6 flex flex-col lg:flex-row items-center gap-12 lg:gap-16"
              >
                <div className="w-full lg:w-1/3 flex flex-col justify-center">
                  ...
                  <p className="text-slate-800 text-lg mb-10 leading-relaxed max-w-sm">
                    Building tomorrow's is our motto & we have been doing exactly that.
                  </p>
                ...
                <div className="w-full lg:w-2/3 relative overflow-hidden rounded-2xl">
                  ...
                  >
                    ...
                    >
                      <img
                        src="/assets/infinity-home/images/index/ongoing-img-1.jpg"
                        alt="Residential"
                      ...
                      />
                      <div
                        className="absolute inset-0 bg-gradient-to-b from-[#0f172a]/70 via-transparent to-[#0f172a]/90 pointer-events-none"
                      ></div>
        
                      <div
                        className="relative h-full p-8 flex flex-col justify-between pointer-events-none"
                      >
                        <div>
                        ...
                        >
                          More Details
                          <span
                            className="flex justify-center w-5 h-5 transition-transform duration-300 transform group-hover/btn:translate-x-1 group-hover/btn:-translate-y-1"
                          >
                            <i
                              className="fa-solid fa-arrow-right fa-rotate-by"
                    ...
                    >
                      <img
                        src="/assets/infinity-home/images/index/ongoing-img-2.jpg"
                        alt="Commercial"
                        className="absolute inset-0 w-full h-full object-cover pointer-events-none transition-transform duration-700 group-hover:scale-105"
                        draggable={false}
                      />
                      ...
                      >
                        <div>
                          <h3 className="text-3xl font-bold text-white mb-2">Commercial</h3>
                          <p className="text-slate-200 text-sm font-medium tracking-wide">
                            10 Properties
                          </p>
                        </div>
                    ...
                    >
                      ...
                      >
                        <div>
                          <h3 className="text-3xl font-bold text-white mb-2">Retail</h3>
                          <p className="text-slate-200 text-sm font-medium tracking-wide">
                            15 Properties
                          </p>
                        </div>
