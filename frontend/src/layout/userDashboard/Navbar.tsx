      ...
      <div className="w-full mx-auto font-sans select-none mb-6">
        <div className="flex items-center justify-between gap-4 mb-8">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <button
              className="bg-[#14213D] text-white px-3 sm:px-5 py-2 rounded-lg font-medium text-xs sm:text-sm border border-[#14213D] hover:bg-white hover:text-[#14213D] transition-all whitespace-nowrap"
            >
