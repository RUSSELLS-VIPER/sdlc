...
import { AgentsSection, CardsSection, FaqSection, GallerySection, GetInTouchSection, TestimonialsSection } from "../../components/Home";
...
const Home = () => {
  ...
  const [calculatorValue, setCalculatorValue] = useState("0");
    ...
    const appendNum = (num: string) => {
      setCalculatorValue((current) => (current === "0" || current === "Error" ? num : current + num));
    };
    ...
    const appendOp = (op: string) => {
      setCalculatorValue((current) => {
        ...
        return ["+", "-", "*", "/"].includes(lastChar) ? current.slice(0, -1) + op : current + op;
      });
    };
    ...
    <>
        <div className="relative w-full flex flex-col">
              <div className="absolute  inset-0 z-0 w-full h-full overflow-hidden">
                ...
                >
                  <source src="/assets/infinity-home/videos/video-test-1.mp4" type="video/mp4" />
                </video>
              ...
              <section className="relative z-10 w-full h-[calc(85vh+112px)] pt-28 flex flex-col">
                ...
                >
                  ...
                  <p
                    className="text-lg md:text-2xl font-medium mb-12 drop-shadow-lg text-gray-200"
                  >
                ...
                <div className="flex justify-center pb-24 md:pb-32 w-full">
                  <div
                    className="w-[20px] h-[34px] border-2 border-white rounded-full flex justify-center pt-1.5 shadow-lg"
                  >
                    <div
                      className="w-0.5 h-2 bg-white rounded-full animate-scroll-wheel"
                    ></div>
                  </div>
                </div>
              </section>
              ...
              <section className="relative z-20 w-full -mt-16">
                <div
                  className="w-full relative rounded-t-[3rem] md:rounded-t-[5rem] p-6 md:p-8 lg:p-16"
                >
                  <div
                    className="absolute inset-0 backdrop-blur-md rounded-t-[3rem] md:rounded-t-[5rem] border-t border-white/30 -z-10"
                  ></div>
        
                  <div
                    className="w-full max-w-5xl mx-auto p-6 md:p-8 rounded-2xl border border-white/50 relative z-10"
                  >
                    <div
                      className="flex flex-col md:flex-row flex-wrap lg:flex-nowrap items-end justify-between gap-4 lg:gap-6"
                    >
                      <div
                        className="flex flex-col gap-1.5 w-full md:w-[calc(50%-0.5rem)] lg:flex-1 relative group"
                      >
                        <label
                          className="text-[10px] md:text-[11px] font-medium text-white/70 uppercase tracking-widest pl-1 whitespace-nowrap"
                          >Looking For</label
                        >
                        <div className="relative cursor-pointer">
                          <div
                            className="w-full bg-white/5 border border-white/20 hover:bg-white/10 rounded-xl px-4 py-3.5 flex items-center justify-between transition-all"
                          >
                            <span
                          ...
                          <div
                            className="absolute top-full mt-2 left-0 w-full bg-[#111827]/95 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl opacity-0 invisible translate-y-4 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-300 z-50 overflow-hidden"
                          >
                      ...
                      >
                        ...
                        <div className="relative cursor-pointer">
                          ...
                          >
                            ...
                            >
                            <i
                              className="fa-solid fa-sort text-[#d4af37] text-xs opacity-70 group-hover:opacity-100"
                            ></i>
                          </div>
                          <div
                            className="absolute top-full mt-2 left-0 w-full bg-[#111827]/95 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl opacity-0 invisible translate-y-4 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-300 z-50 overflow-hidden"
  ...
  const logoSliderSection = (
    <>
        <section
              ...
              style={{ backgroundImage: "url(/assets/infinity-home/images/index/scroll.png)" }}
            >
  ...
  */
  ...
  const videoSection = (
    <>
            <section>
                  <div
                    className="relative w-full h-[50vh] sm:h-[60vh] lg:h-[70vh] flex items-center justify-center overflow-hidden bg-gray-900"
                  >
                    <video
                      id="bgVideo"
                    ...
                    ></div>
                    <div
                      className="relative z-20 flex flex-col items-center justify-center px-4 sm:px-6 w-full max-w-[1320px] mx-auto text-center"
                    >
                      <button
                        id="videoControlBtn"
                      ...
                      <h1
                        className="text-white text-2xl sm:text-3xl md:text-4xl lg:text-[42px] leading-snug md:leading-tight mt-6 md:mt-8 max-w-3xl"
                      >
  ...
  const qrCodeSection = (
    <>
        <section
              className="bg-white flex items-center justify-center min-h-[372px] p-0"
            >
              <div
                className="w-full max-w-7xl bg-white overflow-hidden flex flex-col md:flex-row items-center justify-between px-3 md:px-20 py-10 md:py-0 md:h-[372px]"
              >
                <div
                  className="flex flex-col items-center md:items-center gap-6 order-2 md:order-1 mt-10 md:mt-0"
                >
                ...
                <div className="order-3 mt-10 md:mt-0">
                  <div className="w-[220px] bg-[#1a2b3c] p-3 rounded-[40px] shadow-l">
                    <div
                      className="bg-white rounded-[32px] py-10 px-2 flex flex-col items-center"
                    >
                      <div
                        className="w-full aspect-square bg-gray-50 flex items-center justify-center p-2 mb-6"
                      >
                        <img
                      ...
                      <span className="text-2xl font-bold text-[#1a2b3c]">Scan Me</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="group">
                    ...
                    <button
                      className="border border-gray-300 px-8 py-2.5 rounded-lg text-[#1a2b3c] font-medium hover:bg-[#1a2b3c] hover:text-white transition-colors"
                    >
                      Read More
                    </button>
                  </div>
  ...
  const calculatorSection = (
    <>
            <section className="py-6 sm:py-12 md:py-16 px-4 sm:px-6 md:px-12 lg:px-16">
                  <div className="max-w-7xl mx-auto">
                    <h2
                      className="text-2xl sm:text-4xl md:text-5xl text-[#1a2b3c] mb-8 md:mb-16 text-center md:text-left"
                    >
                    ...
                    <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-6 md:gap-10">
                      <div
                        className="bg-[#f3f6f9] rounded-[1.5rem] sm:rounded-[40px] p-5 sm:p-8 md:p-12 shadow-sm flex items-center justify-between relative overflow-hidden group min-h-[200px] sm:min-h-[260px]"
                      >
                        <div className="flex-1 text-left z-20 max-w-[60%] sm:max-w-[55%]">
                          <h3
                            className="text-lg sm:text-2xl font-semibold text-[#1a2b3c] mb-2 sm:mb-4"
                          >
                            Consultation
                          </h3>
                          <p
                            className="text-gray-600 leading-snug sm:leading-relaxed mb-5 sm:mb-10 text-xs sm:text-lg"
                          >
                          ...
                          >
                            ...
                            <span
                              className="flex justify-center text-[#fca311] group-hover/btn:text-white"
                            >
                      ...
                      <div
                        className="bg-[#f3f6f9] rounded-[1.5rem] sm:rounded-[40px] p-5 sm:p-8 md:p-12 shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between relative overflow-hidden group gap-6 sm:gap-0"
                      >
                        ...
                        <div
                          className="w-full max-w-[200px] bg-[#4b5563] rounded-[1.25rem] sm:rounded-3xl p-3 sm:p-4 shadow-xl z-10 self-center sm:self-auto"
                        >
                          <div
                            id="screen"
                          ...
                          >{calculatorValue}</div>
                          <div
                            className="grid grid-cols-4 gap-1.5 text-white text-center text-xs"
                          >
                            ...
                            <div onClick={() => appendNum("8")}
                              className="calc-btn bg-[#6b7280]/20 py-2.5 sm:py-3 rounded-md cursor-pointer select-none active:scale-95 hover:bg-white/20 transition-all"
                            >
                              8
                            </div>
                            <div onClick={() => appendNum("9")}
                              className="calc-btn bg-[#6b7280]/20 py-2.5 sm:py-3 rounded-md cursor-pointer select-none active:scale-95 hover:bg-white/20 transition-all"
                            >
                              9
                            </div>
                            ...
                            <div onClick={() => appendNum("4")}
                              className="calc-btn bg-[#6b7280]/20 py-2.5 sm:py-3 rounded-md cursor-pointer select-none active:scale-95 hover:bg-white/20 transition-all"
                            >
                              4
                            </div>
                            <div onClick={() => appendNum("5")}
                              className="calc-btn bg-[#6b7280]/20 py-2.5 sm:py-3 rounded-md cursor-pointer select-none active:scale-95 hover:bg-white/20 transition-all"
                            >
                              5
                            </div>
                            <div onClick={() => appendNum("6")}
                              className="calc-btn bg-[#6b7280]/20 py-2.5 sm:py-3 rounded-md cursor-pointer select-none active:scale-95 hover:bg-white/20 transition-all"
                            >
                              6
                            </div>
                            ...
                            <div onClick={() => appendNum("1")}
                              className="calc-btn bg-[#6b7280]/20 py-2.5 sm:py-3 rounded-md cursor-pointer select-none active:scale-95 hover:bg-white/20 transition-all"
                            >
                              1
                            </div>
                            <div onClick={() => appendNum("2")}
                              className="calc-btn bg-[#6b7280]/20 py-2.5 sm:py-3 rounded-md cursor-pointer select-none active:scale-95 hover:bg-white/20 transition-all"
                            >
                              2
                            </div>
                            <div onClick={() => appendNum("3")}
                              className="calc-btn bg-[#6b7280]/20 py-2.5 sm:py-3 rounded-md cursor-pointer select-none active:scale-95 hover:bg-white/20 transition-all"
                            >
                              3
                            </div>
                            <div onClick={() => appendNum("0")}
                              className="calc-btn bg-[#6b7280]/20 py-2.5 sm:py-3 rounded-md cursor-pointer select-none active:scale-95 hover:bg-white/20 transition-all"
                            >
                              0
                            </div>
